      ...
      <div className="grid grid-cols-1 md:grid-cols-3 py-20 gap-10">
        <div>
          <div className="border py-8 px-8 border-black">
            ...
            <p className="py-4">
              <span className="font-bold text-3xl">₹1600</span> per month
            </p>
        ...
        <div>
          <div className="border py-8 px-8 border-black">
            ...
            <p className="py-4">
              <span className="font-bold text-3xl">₹3000</span> per month
            </p>
            <button className="bg-black text-white py-2 rounded-full w-full hover:opacity-70">
              Get Started
            </button>
        ...
        <div>
          <div className="border py-8 px-8 border-black">
            ...
            <p className="py-4">
              <span className="font-bold text-3xl">₹6000</span> per month
            </p>
            <button className="bg-black text-white py-2 rounded-full w-full hover:opacity-70">
              Get Started
            </button>
